#ifndef _ROS_kth_hebi_arm_msgs_JointPoseArray_h
#define _ROS_kth_hebi_arm_msgs_JointPoseArray_h
...
namespace kth_hebi_arm_msgs
{

  class JointPoseArray : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "kth_hebi_arm_msgs/JointPoseArray"; };
    const char * getMD5(){ return "a528a136f6c6b68beaf8e529bd27b9ef"; };
