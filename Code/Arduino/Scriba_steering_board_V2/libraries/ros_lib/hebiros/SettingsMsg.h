...
namespace hebiros
{
  ...
  class SettingsMsg : public ros::Msg
  {
    ...
    SettingsMsg():
      ...
      save_current_settings_length(0), save_current_settings(NULL),
      control_strategy_length(0), control_strategy(NULL),
      position_gains(),
      velocity_gains(),
      effort_gains()
    {
    ...
    const char * getType(){ return "hebiros/SettingsMsg"; };
    const char * getMD5(){ return "4333c3b24c39f74ad09d675d9b50f596"; };
