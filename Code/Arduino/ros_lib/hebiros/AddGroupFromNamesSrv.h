...
static const char ADDGROUPFROMNAMESSRV[] = "hebiros/AddGroupFromNamesSrv";
  ...
  class AddGroupFromNamesSrvRequest : public ros::Msg
  {
    ...
    AddGroupFromNamesSrvRequest():
      ...
      families_length(0), st_families(), families(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return ADDGROUPFROMNAMESSRV; };
    virtual const char * getMD5() override { return "a31d701a4ec2a831130fc40890ab943d"; };
