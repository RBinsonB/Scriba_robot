...
namespace hebiros
{
  ...
  class PidGainsMsg : public ros::Msg
  {
    ...
    PidGainsMsg():
      ...
      ki_length(0), ki(NULL),
      kd_length(0), kd(NULL),
      feed_forward_length(0), feed_forward(NULL),
      dead_zone_length(0), dead_zone(NULL),
      i_clamp_length(0), i_clamp(NULL),
      punch_length(0), punch(NULL),
      min_target_length(0), min_target(NULL),
      max_target_length(0), max_target(NULL),
      target_lowpass_length(0), target_lowpass(NULL),
      min_output_length(0), min_output(NULL),
      max_output_length(0), max_output(NULL),
      output_lowpass_length(0), output_lowpass(NULL),
      d_on_error_length(0), d_on_error(NULL)
    {
    }
    ...
    const char * getType(){ return "hebiros/PidGainsMsg"; };
    const char * getMD5(){ return "409cfb8df90bde199674774f996b26c5"; };
