...
namespace hebiros
{
  ...
  class FeedbackMsg : public ros::Msg
  {
    ...
    FeedbackMsg():
      ...
      position_command_length(0), st_position_command(), position_command(nullptr),
      velocity_command_length(0), st_velocity_command(), velocity_command(nullptr),
      effort_command_length(0), st_effort_command(), effort_command(nullptr),
      accelerometer_length(0), st_accelerometer(), accelerometer(nullptr),
      gyro_length(0), st_gyro(), gyro(nullptr),
      orientation_length(0), st_orientation(), orientation(nullptr),
      deflection_length(0), st_deflection(), deflection(nullptr),
      deflection_velocity_length(0), st_deflection_velocity(), deflection_velocity(nullptr),
      motor_velocity_length(0), st_motor_velocity(), motor_velocity(nullptr),
      motor_current_length(0), st_motor_current(), motor_current(nullptr),
      motor_winding_current_length(0), st_motor_winding_current(), motor_winding_current(nullptr),
      motor_sensor_temperature_length(0), st_motor_sensor_temperature(), motor_sensor_temperature(nullptr),
      motor_winding_temperature_length(0), st_motor_winding_temperature(), motor_winding_temperature(nullptr),
      motor_housing_temperature_length(0), st_motor_housing_temperature(), motor_housing_temperature(nullptr),
      board_temperature_length(0), st_board_temperature(), board_temperature(nullptr),
      processor_temperature_length(0), st_processor_temperature(), processor_temperature(nullptr),
      voltage_length(0), st_voltage(), voltage(nullptr),
      led_color_length(0), st_led_color(), led_color(nullptr),
      sequence_number_length(0), st_sequence_number(), sequence_number(nullptr),
      receive_time_length(0), st_receive_time(), receive_time(nullptr),
      transmit_time_length(0), st_transmit_time(), transmit_time(nullptr),
      hardware_receive_time_length(0), st_hardware_receive_time(), hardware_receive_time(nullptr),
      hardware_transmit_time_length(0), st_hardware_transmit_time(), hardware_transmit_time(nullptr)
    {
    }
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 0) = (this->sequence_number[i] >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->sequence_number[i] >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (this->sequence_number[i] >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (this->sequence_number[i] >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (this->sequence_number[i] >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (this->sequence_number[i] >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (this->sequence_number[i] >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (this->sequence_number[i] >> (8 * 7)) & 0xFF;
      ...
      *(outbuffer + offset + 0) = (this->receive_time[i] >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->receive_time[i] >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (this->receive_time[i] >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (this->receive_time[i] >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (this->receive_time[i] >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (this->receive_time[i] >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (this->receive_time[i] >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (this->receive_time[i] >> (8 * 7)) & 0xFF;
      ...
      *(outbuffer + offset + 0) = (this->transmit_time[i] >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->transmit_time[i] >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (this->transmit_time[i] >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (this->transmit_time[i] >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (this->transmit_time[i] >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (this->transmit_time[i] >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (this->transmit_time[i] >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (this->transmit_time[i] >> (8 * 7)) & 0xFF;
      ...
      *(outbuffer + offset + 0) = (this->hardware_receive_time[i] >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->hardware_receive_time[i] >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (this->hardware_receive_time[i] >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (this->hardware_receive_time[i] >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (this->hardware_receive_time[i] >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (this->hardware_receive_time[i] >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (this->hardware_receive_time[i] >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (this->hardware_receive_time[i] >> (8 * 7)) & 0xFF;
      ...
      *(outbuffer + offset + 0) = (this->hardware_transmit_time[i] >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->hardware_transmit_time[i] >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (this->hardware_transmit_time[i] >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (this->hardware_transmit_time[i] >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (this->hardware_transmit_time[i] >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (this->hardware_transmit_time[i] >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (this->hardware_transmit_time[i] >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (this->hardware_transmit_time[i] >> (8 * 7)) & 0xFF;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      for( uint32_t i = 0; i < sequence_number_length; i++){
      this->st_sequence_number =  ((uint64_t) (*(inbuffer + offset)));
      this->st_sequence_number |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      this->st_sequence_number |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      this->st_sequence_number |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->st_sequence_number |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      this->st_sequence_number |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      this->st_sequence_number |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      this->st_sequence_number |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      ...
      for( uint32_t i = 0; i < receive_time_length; i++){
      this->st_receive_time =  ((uint64_t) (*(inbuffer + offset)));
      this->st_receive_time |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      this->st_receive_time |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      this->st_receive_time |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->st_receive_time |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      this->st_receive_time |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      this->st_receive_time |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      this->st_receive_time |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      ...
      for( uint32_t i = 0; i < transmit_time_length; i++){
      this->st_transmit_time =  ((uint64_t) (*(inbuffer + offset)));
      this->st_transmit_time |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      this->st_transmit_time |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      this->st_transmit_time |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->st_transmit_time |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      this->st_transmit_time |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      this->st_transmit_time |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      this->st_transmit_time |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      ...
      for( uint32_t i = 0; i < hardware_receive_time_length; i++){
      this->st_hardware_receive_time =  ((uint64_t) (*(inbuffer + offset)));
      this->st_hardware_receive_time |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      this->st_hardware_receive_time |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      this->st_hardware_receive_time |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->st_hardware_receive_time |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      this->st_hardware_receive_time |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      this->st_hardware_receive_time |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      this->st_hardware_receive_time |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      ...
      for( uint32_t i = 0; i < hardware_transmit_time_length; i++){
      this->st_hardware_transmit_time =  ((uint64_t) (*(inbuffer + offset)));
      this->st_hardware_transmit_time |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      this->st_hardware_transmit_time |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      this->st_hardware_transmit_time |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->st_hardware_transmit_time |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      this->st_hardware_transmit_time |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      this->st_hardware_transmit_time |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      this->st_hardware_transmit_time |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
    ...
    virtual const char * getType() override { return "hebiros/FeedbackMsg"; };
    virtual const char * getMD5() override { return "f4e368b929bb5d796beb629cf975333e"; };
